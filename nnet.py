...
def convnet(inshape, numclass, activation=tf.nn.relu, regularizer=0.0,
            priorstd=1, poststd=None, isBay=False, repeatConv=1):
...
def fullnet(numclass, activation=tf.nn.relu, regularizer=0.0,
